...
const ActionButtons: React.FC<ActionButtonsProps> = ({ value_id, onDeletionSuccess }) => {
  ...
  return (
    <div className="relative flex items-center gap-2">
      <Link to={`/edit/value/${value_id}`} className="p-1 text-blue-500 hover:text-blue-600" aria-label="Edit">
...
export default function Values() {
  ...
  const fetchValues = useCallback(async () => {
    ...
    try {
      ...
      const errorMessage = 'Failed to fetch values: ' + (err.response?.data?.error || err.message || 'Unknown error');
    ...
    <div className="container mx-auto p-4 sm:p-6">
      ...
      <div className="bg-white rounded-xl shadow-lg p-4 sm:p-6">
        <div className="flex flex-col sm:flex-row justify-between items-center mb-6 gap-4">
          ...
          <Link to="/add/value" className="flex items-center px-4 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition shadow-md">
