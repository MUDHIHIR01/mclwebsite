...
const ActionButtons: React.FC<ActionButtonsProps> = ({ what_we_do_id, onDeletionSuccess }) => {
  ...
  return (
    <div className="relative flex items-center gap-2">
      <Link to={`/edit/what-we-do/${what_we_do_id}`} className="p-1 text-blue-500 hover:text-blue-600" aria-label="Edit">
...
const WhatWeDo: React.FC = () => {
  ...
  const fetchWhatWeDoHomes = useCallback(async () => {
    ...
    try {
      ...
      const errorMessage = 'Failed to fetch what we do entries: ' + (err.response?.data?.message || err.message || 'Unknown error');
  ...
  const columns = useMemo(
    () => [
      ...
      {
        Header: 'Actions',
        accessor: 'what_we_do_id',
        Cell: ({ row }: any) => (
          <ActionButtons what_we_do_id={row.original.what_we_do_id} onDeletionSuccess={fetchWhatWeDoHomes} />
        ),
      },
    ],
    [fetchWhatWeDoHomes]
    ...
    <div className="container mx-auto p-4 sm:p-6">
      ...
      <div className="bg-white rounded-xl shadow-lg p-4 sm:p-6">
        <div className="flex flex-col sm:flex-row justify-between items-center mb-6 gap-4">
          ...
          <Link to="/add/what-we-do" className="flex items-center px-4 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition shadow-md">
