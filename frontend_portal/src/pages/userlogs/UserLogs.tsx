...
const AuditTrail: React.FC = () => {
  ...
  const columns: Column<AuditTrailData>[] = useMemo(
    () => [
      {
        Header: '#',
        accessor: 'id' as any, // Type assertion to handle custom accessor
  ...
  if (loading) {
    return (
      <div className="flex justify-center items-center h-64 w-full">
        ...
        <span className="ml-2 text-gray-700">Loading audit trail...</span>
      </div>
    );
  }
    ...
    <div className="p-4 sm:p-6 lg:p-8 w-full mx-auto">
      ...
      <div className="bg-white rounded-xl shadow-lg p-4 sm:p-6 lg:p-8 w-full">
        <div className="flex justify-between items-center mb-6">
          ...
          <Link
            to="/users"
            className="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition shadow-md text-sm sm:text-base"
          >
            Back to Users
          </Link>
        </div>
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center mb-6 gap-4 w-full">
          ...
          <div className="flex gap-2">
            <button
              onClick={exportToPDF}
              className="px-4 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 transition shadow-md text-sm sm:text-base"
            >
              Export PDF
            </button>
            <button
              onClick={exportToExcel}
              className="px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 transition shadow-md text-sm sm:text-base"
            >
              Export Excel
            </button>
          </div>
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center mt-6 gap-4 w-full">
          <div className="flex gap-2">
            <button
              ...
              className="px-4 py-2 bg-blue-600 text-white rounded-lg disabled:bg-gray-300 hover:bg-blue-700 transition shadow-md text-sm sm:text-base"
