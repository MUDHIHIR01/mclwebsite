      ...
      {showConfirm && (
        <div className="fixed inset-0 bg-gray-600 bg-opacity-50 flex items-center justify-center z-50" role="dialog" aria-modal="true">
          <div className="bg-white rounded-lg shadow-lg p-6 w-full max-w-sm">
            ...
            <p className="text-sm text-gray-600 mb-6">Are you sure you want to delete this giving back home entry?</p>
...
export default function GivingBackHome() {
  ...
  const fetchGivingBackHomes = useCallback(async () => {
    ...
    try {
      ...
      const errorMessage = 'Failed to fetch giving back home entries: ' + (err.response?.data?.message || err.message || 'Unknown error');
      ...
      <div className="bg-white rounded-xl shadow-lg p-4 sm:p-6">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center mb-6 gap-4">
          <input
            ...
            placeholder="Search giving back home entries..."
              ...
              {page.length > 0 ? (
                ...
                <tr>
                  <td colSpan={columns.length} className="text-center py-10 text-gray-500">
                    No giving back home entries found matching your criteria.
                  </td>
                </tr>
              )}
            </tbody>
