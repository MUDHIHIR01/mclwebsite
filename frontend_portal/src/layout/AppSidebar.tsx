...
const getNavItemsForRole = (roleId: number): NavItem[] => {
  ...
  const role1NavItems: NavItem[] = [
    ...
    { name: "About Us", icon: <span className="inline-flex items-center justify-center w-6 h-6 rounded-full bg-orange-600 text-white">ℹ️</span>, subItems: [{ name: "Home Page", path: "/about" }] },
     { name: "About Mwananchi", icon: <span className="inline-flex items-center justify-center w-6 h-6 rounded-full bg-blue-600 text-white">ℹ️</span>, subItems: [{ name: "Manage", path: "/about-mwananchi" }] },
    { name: "Company", icon: <span className="inline-flex items-center justify-center w-6 h-6 rounded-full bg-pink-600 text-white">🏢</span>, subItems: [
        ...
        { name: "MCL Group", path: "/company/mcl-group", subItems: [{ name: "Home page", path: "/mcl-group/home" },{ name: "MCL-Group", path: "/mcl-group" }] },
    ...
    { name: "Careers", icon: <span className="inline-flex items-center justify-center w-6 h-6 rounded-full bg-gray-600 text-white">💼</span>, subItems: [
        ...
        { name: "Early Careers", path: "/careers/early-careers", subItems: [{ name: "Home page", path: "/earycare/home" },{ name: "Eary careers", path: "/early-careers" }] },
      ...
      <div className={`py-8 flex ${!isExpanded && !isHovered ? "lg:justify-center" : "justify-start"}`}>
        <Link to="/dashboard">
          {isExpanded || isHovered || isMobileOpen ? (
            ...
            <h1 className="text-2xl font-bold dark:text-white">M</h1>
          )}
        </Link>
      </div>
